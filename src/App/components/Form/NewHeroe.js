...
class NewHeroe extends Component {
   state={
       heroeArray: [],// almacena el registros Array
       ...stateInicial
   }

    handleChange=(e) =>{

        console.log(e.target.name+':'+e.target.value);//muestra por consola el campo y el usuario que se escribe
        this.setState({
            heroe:{
    ...
    const newHeroe ={...this.state.heroe};// a la constante new heroe le lleva lo que tienen en los inputs
